...
#def AntGridPlot(terrainInfo, fieldSize, PlotDelay, 
		...
		## Plots 
		##=======================================================================
		##			sugar plot   nest plot      
		#Environment.UpdatePlot(antsPlotFood, antsPlotHome, sugarPlot, nestPlot, nestPosition,antsSubPlot, antsFigure, 
							#npaAgentForagingPosX, 
							#npaAgentForagingPosY,
							#npaAgentRetHomePosX, 
							#npaAgentRetHomePosY,
							#npaFoodAmount)
		##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	#def UpdatePlot(antsPlot1, antsPlot2, sugarPlot, nestPlot, nestPosition,antsSubPlot, antsFigure, 
							#new_dataX1, 
							#new_dataY1,
							#new_dataX2, 
							#new_dataY2,
